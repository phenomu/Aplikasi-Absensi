...
public class editDataDosen {
    ...
    public boolean editDosen(String nim, String nama, String password){
        try{
            Hash md5 = new Hash();
            connection = Conn.getConnection();
            String query = "UPDATE dosen SET nim = ?, nama = ?, password = ?  WHERE dosen.nim = ?;";
    ...
    public boolean getDatas(String nim){
        try{
            connection = Conn.getConnection();
            String query = "SELECT * FROM dosen WHERE nim=?";
    ...
    void initialize() {
        ...
        submit.setOnAction(e -> {
            ...
            if (nim.length() != 15 ) {
                ...
                if(editDosen(nim, nama, password)){
